functions_2 = [
    {
        "name": "query_photoobj",
        "description": "Queries the service and returns a table object, At least one of run, camcol or field parameters must be specified. Returns:table A Table object.",
        "parameters": {
            "type": "object",
            "properties": {
                "run": {
                ...
                "fields": {
                    "type": ["array", "null"],
                    "items": { "type": "string" },
                    "description": "SDSS PhotoObj or SpecObj quantities to return. If None, defaults to quantities required to find corresponding spectra and images of matched objects (e.g. plate, fiberID, mjd, etc.)."
                },
                "timeout": {
                    "type": ["number", "null"],
                    "description": "Time limit (in seconds) for establishing a successful connection with the remote server. Defaults to SDSSClass.TIMEOUT."
                },
                "field_help": {
                    "type": ["boolean", "string", "null"],
                    "description": "Field name to check whether a valid PhotoObjAll or SpecObjAll field name. If True or it is an invalid field name, all the valid field names are returned as a dict."
                },
                "get_query_payload": {
                    "type": ["boolean", "null"],
    ...
    {
        "name": "query_photoobj_async",
        "description": "Used to query the PhotoObjAll table with run, rerun, camcol, and field values. At least one of run, camcol, or field parameters must be specified.",
        "parameters": {
            "type": "object",
            "properties": {
                "run": {
    ...
    },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "coordinates": {
                    "type": "string",
                    "description": "The target(s) around which to search. These will be provided in the form of celestial coordinate system, for example 0h8m05.63s +14d50m23.3s or some variant of an input that can be converted to the elestial coordinate system, specifically in the format used for specifying positions in the sky. This format is known as the sexagesimal system, which uses hours, minutes, and seconds to represent angles.",
                },
                "radius": {
                    "type": ["string","null"],
                ...
                "timeout" : {
                  "type": ["number","null"],
                  "description" : "Time limit (in seconds) for establishing successful connection with remote server. Defaults to SDSSClass.TIMEOUT.",
                },
                "fields" : {
                    "type": ["array","null"],
                    "items" : {
                ...
                "photoobj_fields" : {
                    ...
                    "description" : "PhotoObj quantities to return. If photoobj_fields is None and specobj_fields is None then the value of fields is used",
                }
            },
        },
    },
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "radius": {
                    "type": ["string", "null"],
                    "description": "The string must be parsable by Angle. The appropriate Quantity object from astropy.units may also be used. The maximum allowed value is 3 arcmin",
                },
                "width" : {
                  "type": ["string", "null"],
        ...
        },
    {
        ...
        "parameters": {
            ...
            "properties": {
                "kind": {
                    "type": ["string", "array"],
                    "description": "Which spectral template to download? Options are stored in the dictionary astroquery.sdss.SDSS.AVAILABLE_TEMPLATES."
                },
                "timeout": {
                    "type": ["number", "null"],
                    "description": "Time limit (in seconds) for establishing a successful connection with the remote server. Defaults to SDSSClass.TIMEOUT."
